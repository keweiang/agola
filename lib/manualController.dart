  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: JoyPad2(
          ...
          dropdownValue3: this.dropdownValue3,
          dropdownValue4: this.dropdownValue4,
          dropdownValue5: this.dropdownValue5,
          dropdownValue6: this.dropdownValue6,
          dropdownValue7: this.dropdownValue7,
          dropdownValue8: this.dropdownValue8),
...
// ignore: must_be_immutable
class JoyPad2 extends StatefulWidget {
  int dropdownValue,
      dropdownValue2,
      dropdownValue3,
      dropdownValue4,
  ...
  JoyPad2(
      ...
      this.dropdownValue8});
  @override
  _JoyPad2State createState() => _JoyPad2State(
      dropdownValue,
      dropdownValue2,
      dropdownValue3,
      dropdownValue4,
...
class _JoyPad2State extends State<JoyPad2> {
  int dropdownValue,
      dropdownValue2,
      dropdownValue3,
      dropdownValue4,
  ...
  // ignore: unused_field
  double _joystickDegree, _joystickDistance;
  // ignore: unused_field
  int _deviceState;
